...
public class GenericConvert {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GenericConvert window = new GenericConvert();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Process Any Tab Delim file into Pipe Delim");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					outputFilebyFile = "2135_RCH_" + strDate + ".txt";
				
			
				JFileChooser fc = new JFileChooser(); 
				fc.setCurrentDirectory(new java.io.File("C:/Reports/RxStrategies")); 
